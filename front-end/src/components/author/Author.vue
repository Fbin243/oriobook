    ...
    <div class="row">
      <div class="col-12 bwp-author-heading">
        <div class="author-image">
          <div class="images">
            <img :src="author.image" :alt="author.name" style="height: auto;" />
        ...
        <div class="author-content">
          ...
          <ul class="social-link">
            ...
            <li>
              <a href="#" class="google"><i class="fa fa-google-plus-g"></i>Google</a>
            </li>
            <li>
  ...
  setup() {
    ...
    onMounted(async () => {
      try {
        ...
        const response = await axios.get(`http://localhost:3000/product/productAuthor/${id.value}`);
